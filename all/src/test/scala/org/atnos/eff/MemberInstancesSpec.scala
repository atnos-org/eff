...
class MemberInstancesSpec extends Specification with ThrownExpectations {
  def is = s2"""
...
"""
  ...
  def memberAppendR = {
    ...
    Member
      .MemberAppendR[T5, Fx2[T1, T2], Fx3[T3, T4, T5], Fx2[T3, T4]](using Member.Member3R[T3, T4, T5])
