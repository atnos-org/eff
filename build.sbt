...
lazy val specs2Version = Def.setting("4.23.0")
...
libraryDependencies += "org.scala-lang.modules" %% "scala-collection-compat" % "2.14.0" % Test
...
lazy val catsEffect = crossProject(JVMPlatform)
  ...
  .settings(
    libraryDependencies += "org.typelevel" %%% "cats-effect" % "3.6.4",
  )
  .jvmSettings(commonJvmSettings)
