...
def runInteract[R <: Effects, A](effects: Eff[R, A])(implicit m: Member[Interact, R]): Eff[m.Out, A] = {
...
def runDataOp[R <: Effects, A](effects: Eff[R, A])(implicit m: Member[DataOp, R]): Eff[m.Out, A] = {
